...
public class player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (shipview == false && us.selectedunits.Count > 0)
            {
                shipview = true;
                GetComponent<CameraController>().enabled = false;
                GetComponent<Camera>().fieldOfView = 60;
                transform.position = us.selectedunits[0].transform.Find("camerapoint").position;
                transform.rotation = us.selectedunits[0].transform.Find("camerapoint").rotation;
                transform.parent = us.selectedunits[0].transform.Find("camerapoint");
                us.selectedunits[0].transform.Find("healthbar").GetComponent<Canvas>().enabled = false;
            ...
            else if (shipview == true)
            {
                ...
                us.selectedunits[0].transform.Find("healthbar").GetComponent<Canvas>().enabled = true;
